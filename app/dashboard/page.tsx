...
import { BookOpen, FileText, LinkIcon, Users } from "lucide-react"
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
              <Card className="col-span-4">
                <CardHeader>
                  ...
                  <CardDescription>Liste des dernières ressources ajoutées à la base de connaissances</CardDescription>
                </CardHeader>
                <CardContent>
                  <KnowledgeTable />
                </CardContent>
